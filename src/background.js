try {
    ...
    extension.removeAllContextMenu(function () {
        ...
        extension.addContextMenu({
            ...
            onclick: function (info) {
                extension.getStorage(['profil'], function (value) {
                    openInTab(value.profil.link+"/overview");
                });
            }
        });
        extension.addContextMenu({
            ...
            onclick: function (info) {
                extension.getStorage(['profil'], function (value) {
                    openInTab("https://www.dealabs.com/profile/messages");
                });
            }
        });
        extension.addContextMenu({
            ...
            contexts: ['browser_action'],
            onclick: function (info) {
                openInTab(value.profil.link+"/keyword-alarms");
            }
        });
        extension.addContextMenu({
            ...
            contexts: ['browser_action'],
            onclick: function (info) {
                openInTab(value.profil.link+"/saved-deals");
            }
        });
        // extension.addContextMenu({
        ...
        extension.addContextMenu({
            ...
            id: 'plugin_topic',
            onclick: function (info) {
                openInTab("https://www.dealabs.com/feedback/plugin-plugin-chromefirefox-pour-dealabs-non-officiel-1076744");
            }
        });
        extension.addContextMenu({
